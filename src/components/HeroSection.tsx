    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden particle-bg">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto reveal">
          {/* Premium Badge */}
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-6 py-2 mb-8 scale-pulse">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              className="text-lg px-8 py-4 group relative overflow-hidden btn-ripple shine-effect"
            >
            ...
            <Button 
              ...
              className="text-lg px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-white/30 text-white hover:bg-white hover:text-foreground hover:border-white shine-effect"
            >
            ...
            <Button 
              ...
              className="bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 text-lg px-8 py-4 btn-ripple"
            >
              Explore Plans
            </Button>
          </div>
